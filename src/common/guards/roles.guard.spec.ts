...
describe('RolesGuard', () => {
  ...
  describe('canActivate', () => {
    it('should allow access when no roles are required', () => {
      ...
      const context = createMockExecutionContext({ id: 1, role: UserRole.STUDENT });
    ...
    it('should allow access when user has admin role and admin is required', () => {
      ...
      const context = createMockExecutionContext({ id: 1, role: UserRole.ADMIN });
    ...
    it('should allow access when user has teacher role and teacher is required', () => {
      ...
      const context = createMockExecutionContext({ id: 1, role: UserRole.TEACHER });
    ...
    it('should allow assistant access when assistant role is required', () => {
      jest.spyOn(reflector, 'getAllAndOverride').mockReturnValue([UserRole.ASSISTANT]);
      const context = createMockExecutionContext({ id: 1, role: UserRole.ASSISTANT });
